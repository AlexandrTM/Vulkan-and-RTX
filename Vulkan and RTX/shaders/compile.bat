...
"O:\SDKforeverything\VulkanSDK\Bin\glslangValidator.exe" ui.vert -V -o ui.vert.spv
"O:\SDKforeverything\VulkanSDK\Bin\glslangValidator.exe" ui.frag -V -o ui.frag.spv
pause